...
## Group Name Group 311:6 (replace XXX with the assigned group name)

## Contributing Group Members

- Reena Singhal, Jiahua Pan, **Kai Tsuyoshi**

## Group Members Who Did Not Contribute

- Fei Qin, Malavika Unnikrishnan
...
```{r question-1}
  ggplot(planets) +
  geom_point(mapping = aes(x = radius, y = mass)) +
...
```{r question-3}
  ...
  ggplot(planets, aes(x = radius, y = mass, color = method)) +
  geom_point()+
  scale_y_log10() +
  scale_x_log10() +
  xlab("Radius") +
...
Mass and radius have a positive linear (approximate) correlation 
...
# 
  ...
  # Response:Adds a smooth line that is fitted to the data
  geom_smooth(method="lm", se=FALSE) +
  ## ADD A COMMENT SAYING WHAT THE NEXT LINE DOES
  # Response:Creates separate subplots of the data, (based on method of discovery)
  facet_wrap(~method) +
  xlab("Radius") +
  ylab("Mass (Earth Mass)") +
  ggtitle("Exoplanets Mass vs. Radius",
